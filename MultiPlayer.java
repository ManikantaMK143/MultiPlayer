...
public class MultiPlayer extends Thread {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		String st = "Welcome to my Playlist\n";
		...
		arrayList.add("Samajavaragamana");
		arrayList.add("bheemala");
		arrayList.add("BhamAkanda");
		arrayList.add("Leharayee");
		arrayList.add("BreathelessSong");
		arrayList.add("HaiApnaDilAwara");
		arrayList.add("TeriMetti");
		arrayList.add("RowdyBaby");
		arrayList.add("VipTheme");
		arrayList.add("MissaBeauti");
	...
	public void searchSong(ArrayList<String> arrayList) throws InterruptedException {
		...
		for (int i = 0; i < arrayList.size(); i++) {
			if (arrayList.get(i).equalsIgnoreCase(userInput)) {
				...
				if (userOption1 == 1) {
					multiplayer.toShowMenu(arrayList);
